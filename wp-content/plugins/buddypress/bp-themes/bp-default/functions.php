...
global $bp;
if ( bp_is_activity_component() || is_page_template(‘index.php’) || bp_is_groups_component() || bp_is_blogs_component() || bp_is_page( BP_MEMBERS_SLUG ) ) {
